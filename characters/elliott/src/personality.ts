...
export function getContextualPrompt(context: {
  ...
  // Determine what Elliott might be doing
  let lifeTexture = '';
...
export const THINKING_TOPICS = {
  ...
  decisions: [
    ...
    'decision_fatigue',
    'commitment_after_deciding'
  ],
  learning: [
    'reading_vs_understanding',
    'writing_as_thinking',
    'teaching_to_learn',
    'changing_your_mind'
  ]
